...
<%  
	...
	List<GuideRepVO> guideRepList = repSvc.getAllStatus(2);
...
<body>
	...
	<div class="container-fluid">
		<div class="navbar-header ">
			<img class="navbar-brand navbar-brand-custom" src="<%=request.getContextPath()%>/back_end/guideRep/img/LogoSmall2.png" id="nav-logo"> 
		...
		<div class="row">
			<div>
				...
				<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
					...
					<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back_end/guideRep/listAllGuideRep.jsp" style="margin-bottom: 0px;">
					
					<div align="right">
						<select name="Sorting" onChange="location = this.options[this.selectedIndex].value;">
							<option>請選擇案件狀態查詢</option>
							<option value="<%=request.getContextPath()%>/back_end/guideRep/listAllGuideRep1.jsp">未審核</option>
							<option value="<%=request.getContextPath()%>/back_end/guideRep/listAllGuideRep2.jsp">無效檢舉</option>
							<option value="<%=request.getContextPath()%>/back_end/guideRep/listAllGuideRep3.jsp">有效檢舉</option>
						</select>
					</div>
					</FORM>
					<br>	
				...
				<div>
											...
											<td height="30"><div align="center"><fmt:formatDate value="${guideRepVO.getGuideRepDate()}" pattern="yyyy-MM-dd"/></div></td>
												...
												<div align="center">
													<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/guideRep.do" style="margin-bottom: 0px;">
														...
														<input type="hidden" name="requestURL"value="/back_end/guideRep/listAllGuideRep2.jsp">
								...
								<%if (request.getAttribute("guideRepVO") != null) { %>
									<jsp:include page="/back_end/guideRep/listOneGuideRep.jsp"/>
								<%}%>
							</div>
