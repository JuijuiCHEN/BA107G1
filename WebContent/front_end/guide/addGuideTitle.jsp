		...
		<div data-hypernova-key="list_your_spacebundlejs"
			...
			<div data-reactroot>
				<div>
					<div class="bg-white">
						<div>
							<div class="landing-width bg-white row row-condensed list-your-space__landing-content" style="padding-top:100px">
								<span>
									<div class="col-md-6 landing__left-col fast-animation">
										<div class="landing__left-col-content">
											<div class="space-5">
												<h2 class="landing__title-title">
													<span>你好，來撰寫一筆指南文章吧！</span>
												</h2>
											</div>
											<div class="landing__step-content landing__wmpw-controls">
												...
												<form action="<%=request.getContextPath() %>/front_end/guide/addGuideContent.jsp" id="titleKeep" class="earning-estimation-container"
													...
													<div
														style="margin-top: 20%; margin-bottom: 28px; margin-right: 50%;">
														<div class="wrap">
															<div>
