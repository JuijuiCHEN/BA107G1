		...
		<ul>
			...
			<li>
				<FORM METHOD="post" ACTION="guideRep.do">
					...
					<br> 檢舉編號: <input type="text" name="guideRepId"
						...
						name="action" value="delete"><br> <input
						type="submit" value="送出">
					<h4>(資料格式驗證 by Controller ).</h4>
				</FORM>
			</li>
			...
			<li>
				<FORM METHOD="post" ACTION="guideImg.do"
					...
					<h2>新增指南圖片:</h2>
					<br> 指南編號: <input type="text" name="guideId" value="G000001"><br>
					<input type="file" name="saveDirectory"> <input
						type="hidden" name="action" value="insert"><br> <input
						type="submit" value="送出">
					<h4>(資料格式驗證 by Controller ).</h4>
				</FORM>
			...
			<li>
		<h2>查詢指南圖片:</h2>
		<%-- <c:import url="<%=request.getContextPath()+request.getServletPath()%>" > --%>
		<%-- 	<c:param name="guideImgId" value="GR000016"/> --%>
		<%-- </c:import> --%>

		<img src="<%=request.getContextPath()%>/guideImg.do?action=findByPrimaryKey&guideImgId=GI000016">
