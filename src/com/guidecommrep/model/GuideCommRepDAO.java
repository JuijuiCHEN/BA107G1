...
public class GuideCommRepDAO implements GuideCommRepDAO_interface {
	...
	private static final String INSERT_STMT = "insert into g_comm_rep(g_comm_rep_id, comm_id, mem_id, guide_comm_rep_content, guide_comm_rep_status)values('GCR'||LPAD(to_char(G_COMM_REP_PK_SEQ.NEXTVAL), 6, '0'), ?, ?, ?, '未審核')";
