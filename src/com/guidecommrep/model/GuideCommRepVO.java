...
public class GuideCommRepVO {
	...
	public String toString() {
		return "GuideCommRepVO [g_comm_rep_id=" + g_comm_rep_id + ", comm_id=" + comm_id + ", mem_id=" + mem_id
				+ ", guide_comm_rep_date=" + guide_comm_rep_date + ", guide_comm_rep_content=" + guide_comm_rep_content
				+ ", guide_comm_rep_status=" + guide_comm_rep_status + "]";
	}
